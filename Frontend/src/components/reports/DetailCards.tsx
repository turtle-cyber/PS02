...
export const DetailCards: React.FC<DetailCardsProps> = ({ data }) => {
  return (
    <>
        ...
        <div className="grid grid-row-1 lg:grid-row-2 gap-8"> 
          <LiquidCard variant="glass">
            ...
            <div className="ml-4 mb-4 mr-4">
              <MetricRow label="A Count" value={data.aCount} />
              <MetricRow label="NS Count" value={data.nsCount} />
              <MetricRow label="MX Count" value={data.mxCount} />
            </div>
          </LiquidCard>
          <LiquidCard variant="glass">
            ...
            <div className="ml-4 mb-4 mr-4">
              <MetricRow
                ...
                value={data.isNewlyRegistered}
              />
              <MetricRow label="Is Very New" value={data.isVeryNew} />
              <MetricRow
      ...
      <div className="mb-6">
        <LiquidCard variant="glass">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-x-8 gap-y-2 ml-4 mb-4 mr-4">
            ...
            <MetricRow label="URL Entropy" value={data.urlEntropy.toFixed(2)} />
            <MetricRow
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <LiquidCard variant="glass">
          ...
          <div className="ml-4 mb-4 mr-4 ">
            ...
            />
            <MetricRow label="Has Suspicious Form Name" value="Yes" />
