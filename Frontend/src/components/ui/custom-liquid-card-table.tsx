...
export const CustomLiquidCardTable = React.forwardRef<HTMLDivElement, LiquidCardProps>(
  ({ className, children, variant = 'default', allowOverflow = false, ...props }, ref) => {

    const glassStyles = 'rounded-2xl border border-white/10' +
    ...
    const defaultStyles = "rounded-2xl border border-white/6" +
...
CustomLiquidCardTable.displayName = "CustomLiquidCard";